...
//     	JMenuItem addResourceMenuItem = new JMenuItem(MessageBundle.get("menu.edit.add.bundle"));
//     	addResourceMenuItem.addActionListener(e -> editor.showAddBundleDialog());
//     	addResourceMenuItem.setAccelerator(KeyStroke.getKeyStroke('R', Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
...
//        addLocaleMenuItem.add(addEs6ResourceMenuItem);
     	...
     	JMenuItem addLocaleMenuItem = new JMenuItem(MessageBundle.get("menu.edit.add.locale.title"));
     	addLocaleMenuItem.addActionListener(e -> editor.showAddLocaleDialog(ResourceType.JSON));
     	addLocaleMenuItem.setAccelerator(KeyStroke.getKeyStroke('J', Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
