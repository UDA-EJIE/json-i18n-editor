...
//		DefaultTreeCellRenderer renderer = new DefaultTreeCellRenderer();
		Icon emptyIcon = getResourceImage("images/warning.png");
		
		DefaultTreeCellRenderer renderer =(DefaultTreeCellRenderer) new ResourceTreeCellRenderer(editor, emptyIcon);
	...
	private Icon getResourceImage(String path) {
